package com.android.nikunj.nerdlauncher;
...
import static com.android.nikunj.nerdlauncher.NerdLauncherFragment.*;

/**
 * Created by nikunjgoel on 22-07-2017.
 */
...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mNameTextView = (TextView) itemView.findViewById(R.id.text_view_list);
            mImageView = (ImageView) itemView.findViewById(R.id.image_view_list);
